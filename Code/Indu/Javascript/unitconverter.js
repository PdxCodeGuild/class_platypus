...
inunit= prompt("What is the unit of your input? feet,meters,Kilometer,mile,yard,inch\n")
outunit= prompt("what is the unit of your output? feet,meters,Kilometer,mile,yard,inch\n")
...
alert(f"{distance} {inunit} is {distanceinmeter/convert2meter[outunit]} {outunit}")
