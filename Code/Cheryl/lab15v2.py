...
user_input = int(input('Enter a number from 100-999.  >   '))
...
num_dict_hundreds = {100: 'one hundred'}
...
elif hundreds_digit in num_dict_hundreds:
    print(num_dict_hundreds[hundreds_digit], end='-')
    # print(num_dict_tens[tens_digit], end='-')
    # print(num_dict_ones[ones_digit])
